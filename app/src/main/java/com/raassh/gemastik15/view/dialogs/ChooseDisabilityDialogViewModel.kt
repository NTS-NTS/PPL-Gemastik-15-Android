...
class ChooseDisabilityDialogViewModel(private val authenticationRepository: AuthenticationRepository, private val userPreferences: UserPreferences) : ViewModel() {
    ...
    fun setHasDisability(hasDisability: Boolean) {
        viewModelScope.launch {
            userPreferences.setHasDisabilityTypes(hasDisability)
        }
    }
}